									...
									<div class="col-sm-6 col-md-3">
										<div class="form-group">
											...
											<div class="cal-icon">
												...
												<input name="invoicedate" value="<%= invoice.getInvoicedate() %>" required class="form-control " type="text">
											</div>
										</div>
									</div>
									<div class="col-sm-6 col-md-3">
										<div class="form-group">
											...
											<div class="cal-icon">
												...
												<input name="duedate" value="<%= invoice.getDueDate() %>" required class="form-control " type="text">
												...
												<tbody>
													...
													<tr>
														...
														<td style="text-align: right; padding-right: 30px;width: 230px">
															...
															<input name="discount" id="discount" class="form-control text-right" type="text"  onblur="calculateAll()" value="<%= invoice.getDiscount() %>" >
