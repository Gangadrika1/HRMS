...
<html lang="en">
    ...
    <!-- /Sidebar -->
            ...
            <div class="page-wrapper">
				...
				<?php include_once("includes/modals/projects/add.jsp") ?>
				<!-- /Create Project Modal -->
				
				<!-- Edit Project Modal -->
				<?php include_once("includes/modals/projects/edit.jsp"); ?>
				<!-- /Edit Project Modal -->
				
				<!-- Delete Project Modal -->
				<?php include_once("includes/modals/projects/delete.jsp"); ?>
				<!-- /Delete Project Modal -->
