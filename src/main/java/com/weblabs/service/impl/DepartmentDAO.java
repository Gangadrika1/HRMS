    ...
    public static List<AddDepartment> getFilteredDepartments(String whereClause, int start, int limit) {
        ...
        try {
            ...
            if (whereClause != null && !whereClause.isEmpty()) {
                query = "SELECT DepartmentId, DepartmentName, Date FROM departments WHERE " + whereClause + " LIMIT ?, ?;";
            } else {
                query = "SELECT DepartmentId, DepartmentName, Date FROM departments LIMIT ?, ?;";
            }
            ...
            while (resultSet.next()) {
                ...
                department.setid(resultSet.getString("DepartmentId"));
    ...
    public static List<AddDepartment> getAllDepartmenet() {
        ...
        try {
            ...
            while (resultSet.next()) {
            	...
            	dept.setid(resultSet.getString("DepartmentId"));
